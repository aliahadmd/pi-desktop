...
| [011](011-snippet-segments-no-raw-html.md) | Snippet segments instead of raw HTML (H-3) | P1 | M | MED | — | TODO |
| [012](012-small-fixes-batch.md) | Four small fixes: editor fallback, onboarding memory, log retention, timer leak (M-1, M-4, M-6, M-7) | P2 | S | LOW | 008 soft (file overlap) | TODO |
